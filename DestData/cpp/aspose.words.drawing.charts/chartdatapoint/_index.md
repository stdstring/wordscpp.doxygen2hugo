...
| Method | Description |
| --- | --- |
| void [ClearFormat](./clearformat/)() | Clears format of this data point. The properties are set to the default values defined in the parent series.  |
...
| System::SharedPtr< Aspose::Words::Drawing::Charts::ChartFormat > [get_Format](./get_format/)() | Provides access to fill and line formatting of this data point.  |
| int32_t [get_Index](./get_index/)() | Index of the data point this object applies formatting to.  |
