---
title: Aspose::Words::WebExtensions::TaskPane::get_DockState method
linktitle: get_DockState
...
```cpp
Aspose::Words::WebExtensions::TaskPaneDockState Aspose::Words::WebExtensions::TaskPane::get_DockState() const
```
