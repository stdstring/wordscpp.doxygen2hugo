...
| static [Cr](./cr/)() | Carriage return character: "\x000d" or "\r". Same as ParagraphBreak.  |
...
| static [PageBreak](./pagebreak/)() | Page break character: "\x000c" or "\f". Note it has the same value as SectionBreak.  |
| static [ParagraphBreak](./paragraphbreak/)() | End of paragraph character: "\x000d" or "\r". Same as Cr |
| static [SectionBreak](./sectionbreak/)() | End of section character: "\x000c" or "\f". Note it has the same value as PageBreak.  |
