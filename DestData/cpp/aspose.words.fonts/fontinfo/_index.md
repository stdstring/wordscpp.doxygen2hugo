...
| [set_AltName](./set_altname/)(const System::String &) | Setter for Aspose::Words::Fonts::FontInfo::get_AltName.  |
| [set_Charset](./set_charset/)(int32_t) | Setter for Aspose::Words::Fonts::FontInfo::get_Charset.  |
| [set_Family](./set_family/)(Aspose::Words::Fonts::FontFamily) | Setter for Aspose::Words::Fonts::FontInfo::get_Family.  |
| [set_IsTrueType](./set_istruetype/)(bool) | Setter for Aspose::Words::Fonts::FontInfo::get_IsTrueType.  |
| [set_Panose](./set_panose/)(const System::ArrayPtr< uint8_t > &) | Setter for Aspose::Words::Fonts::FontInfo::get_Panose.  |
| [set_Pitch](./set_pitch/)(Aspose::Words::Fonts::FontPitch) | Setter for Aspose::Words::Fonts::FontInfo::get_Pitch.  |
