...
description: Aspose::Words::Fields::FieldRef::get_InsertParagraphNumber method. Gets or sets whether to insert the paragraph number of the referenced paragraph exactly as it appears in the document in C++.
type: docs
weight: 53
