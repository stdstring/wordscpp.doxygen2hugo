...
Gets a value that specifies how to align contents in tables when exporting into the [Markdown](../../../aspose.words/saveformat/) format. The default value is [Auto](../../tablecontentalignment/).
