...
| [get_Count](./get_count/)() const | Gets or sets how many Character to use as indentation per one list level. The default value is 0, that means no indentation.  |
| [set_Character](./set_character/)(char16_t) | Setter for Aspose::Words::Saving::TxtListIndentation::get_Character.  |
| [set_Count](./set_count/)(int32_t) | Setter for Aspose::Words::Saving::TxtListIndentation::get_Count.  |
